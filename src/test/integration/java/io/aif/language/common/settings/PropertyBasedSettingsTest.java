...
public class PropertyBasedSettingsTest {
    ...
    private static void experimentWith_splitter_characters_grouper_search_step() throws Exception {
        ...
        for (Double splitter_characters_grouper_search_step = 0.00005; splitter_characters_grouper_search_step < 0.16; splitter_characters_grouper_search_step += 0.00005) {
