...
/**
 * @Test This class gets results made by AIF2NLPSentenceSplitter, OpenNLPSentenceSplitter,
 * StanfordNLPSentenceSplitter classes and compares it with a standard text body. The standard must
 * to be 100% correct and has the exact number of sentences. And if we compare our result with the
 * standard, we will get quality output result.
 *
 * author oakslist
 */
  ...
  public void sentenceSplittersTest(final TestData testData) throws Exception {
    ...
    try (final InputStream resourceFile =
      ...
      logger.debug(String.format("Quality test result: \n" +
          ...
          testData.getSentenceCount(), aifResult, openNlpResult, stanfordResult));
