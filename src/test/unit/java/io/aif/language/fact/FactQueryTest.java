...
public class FactQueryTest {
    ...
    public void testFindPath() throws Exception {
        ...
        List<ISemanticNode<IWord>> sentence1 = Arrays.asList(mockNode0, mockNode1);
        ...
        List<ISemanticNode<IWord>> sentence2 = Arrays.asList(mockNode1, mockNode2);
        ...
        List<ISemanticNode<IWord>> sentence3 = Arrays.asList(mockNode1, mockNode3);
        ...
        List<ISemanticNode<IWord>> sentence4 = Arrays.asList(mockNode3, mockNode4);
    ...
    public void testFindPathNoConnection() throws Exception {
        ...
        ISemanticNode<IWord> mockNode4 = mock(ISemanticNode.class);
        when(mockNode4.isProperNoun()).thenReturn(trueFuzzy);
        List<ISemanticNode<IWord>> sentence4 = Arrays.asList(mockNode4);
        IFact fact4 = new Fact(sentence4);
    ...
    public void testFindPathProperNounsInTheSameFact() throws Exception {
        ...
        ISemanticNode<IWord> mockNode4 = mock(ISemanticNode.class);
        when(mockNode4.isProperNoun()).thenReturn(trueFuzzy);
        List<ISemanticNode<IWord>> sentence4 = Arrays.asList(mockNode4, mockNode3);
        IFact fact4 = new Fact(sentence4);

        ISemanticNode<IWord> mockNode5 = mock(ISemanticNode.class);
        when(mockNode5.isProperNoun()).thenReturn(trueFuzzy);
        List<ISemanticNode<IWord>> sentence5 = Arrays.asList(mockNode5, mockNode2);
    ...
    public void testFindPathMultiplePathsWithEqualCost() throws Exception {
        ...
        List<ISemanticNode<IWord>> sentence1 = Arrays.asList(mockNode0, mockNode1, mockNode2);
        IFact fact1 = new Fact(sentence1);

        List<ISemanticNode<IWord>> sentence2 = Arrays.asList(mockNode1);
        IFact fact2 = new Fact(sentence2);

        List<ISemanticNode<IWord>> sentence3 = Arrays.asList(mockNode2);
        IFact fact3 = new Fact(sentence3);

        ISemanticNode<IWord> mockNode3 = mock(ISemanticNode.class);
        when(mockNode3.isProperNoun()).thenReturn(trueFuzzy);
        when(mockNode3.toString()).thenReturn("mockNode4");
        List<ISemanticNode<IWord>> sentence4 = Arrays.asList(mockNode3, mockNode1, mockNode2);
        IFact fact4 = new Fact(sentence4);
