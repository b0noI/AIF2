...
public class StatSentenceSeparatorExtractorTest {
  ...
  public void testExtract() throws Exception {
    ...
    // expected results
    final Optional<List<Character>> expectedResult = Optional.of(Collections.singletonList('a'));
  ...
  public void testGetCharacters() throws Exception {
    // input arguments
    final List<String> inputArguments = Arrays.asList("token", "otkne");

    // mocks
    final StatSeparatorExtractor.CharacterStat mockCharacterStat =
        mock(StatSeparatorExtractor.CharacterStat.class);
    ...
    final StatSeparatorExtractor testInstance = new StatSeparatorExtractor() {
      ...
      List<CharacterStat> getNormalizedCharactersStatistic(final StatData startCharacterStatData,
        ...
        assertEquals(
            startCharacterStatData.getProbabilityThatCharacterIsSplitterCharacter('t'), 0.125);
        assertEquals(
            startCharacterStatData.getProbabilityThatCharacterIsSplitterCharacter('o'), 0.125);
        assertEquals(
            startCharacterStatData.getProbabilityThatCharacterIsSplitterCharacter('k'), 0.0);
        assertEquals(
            startCharacterStatData.getProbabilityThatCharacterIsSplitterCharacter('e'), 0.0);
        assertEquals(
            startCharacterStatData.getProbabilityThatCharacterIsSplitterCharacter('n'), 0.0);
        assertEquals(
            endCharactersStatData.getProbabilityThatCharacterIsSplitterCharacter('t'), 0.0);
        assertEquals(
            endCharactersStatData.getProbabilityThatCharacterIsSplitterCharacter('o'), 0.0);
        assertEquals(
            endCharactersStatData.getProbabilityThatCharacterIsSplitterCharacter('k'), 0.0);
        assertEquals(
            endCharactersStatData.getProbabilityThatCharacterIsSplitterCharacter('e'), 0.125);
        assertEquals(
            endCharactersStatData.getProbabilityThatCharacterIsSplitterCharacter('n'), 0.125);
...
//        // input arguments
//        final StatSeparatorExtractor.CharacterStat stat1 =
//            new StatSeparatorExtractor.CharacterStat('t', 0.1);
//        final StatSeparatorExtractor.CharacterStat stat2 =
//            new StatSeparatorExtractor.CharacterStat('o', 0.2);
...
//
//        // execution test
//        final List<StatSeparatorExtractor.CharacterStat> actualResult =
//            testInstance.firstFilter(inputStats);
//
//        // result assert
//        assertEquals(actualResult, expectedResult);
//
//    }
  ...
  public void testGetCharactersStatistic() throws Exception {
    ...
    // execution test
    final List<StatSeparatorExtractor.CharacterStat> actualResult =
        testInstance.getNormalizedCharactersStatistic(startCharacterStatData, endCharacterStatData);
  ...
  public void testFilter() throws Exception {
    // input arguments
    final List<String> inputTokens = Arrays.asList("tOKen", "token...", "tok", "0");

    // mocks

    // expected results
    final List<String> expectedResult = Arrays.asList("token", "token.");
