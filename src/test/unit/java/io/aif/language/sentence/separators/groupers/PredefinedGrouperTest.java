...
public class PredefinedGrouperTest {
  ...
  public void testGroup() throws Exception {
    // input arguments
    final List<Character> inputSplitters = Arrays.asList('.', '\'', '#', '$', '!');
    ...
    final ISeparatorsGrouper sentenceSeparatorsGrouper =
        ISeparatorsGrouper.Type.PREDEFINED.getInstance();

    // execution test
    final List<Set<Character>> actualResult =
        sentenceSeparatorsGrouper.group(inputTokens, inputSplitters);
