...
public class StringHelperTest {
  ...
  @Test(groups = "unit-tests")
  public void testFindBiggestSubstringFirstStrIsSubstrofSecondStrCaseInsensitive()
      throws Exception {
  ...
  @Test(groups = "unit-tests")
  public void testFindBiggestSubstringSecondStrIsSubstrofFirstStrCaseInsensitive()
      throws Exception {
  ...
  @Test(groups = "unit-tests")
  public void testGenerateSubWordWordLengthIsLessThanTheLengthOfWordsToBeGenerated()
      throws Exception {
